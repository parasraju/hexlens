...
function buildDEX(): Uint8Array {
  const buf = new Uint8Array(0x200)
  const v = new DataView(buf.buffer)

  buf.set([0x64, 0x65, 0x78, 0x0A, 0x33, 0x35, 0x00, 0x00], 0)
...
function buildDotNet(): Uint8Array {
